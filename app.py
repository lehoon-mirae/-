...
def df_to_merged_html(df):
    ...
    html = '<div style="width: 100% !important; max-width: 100% !important; max-height: 780px; overflow-y: auto; overflow-x: auto; border: 1px solid #E2E8F0; border-radius: 12px; box-shadow: 0 6px 24px rgba(0, 0, 0, 0.06); display: block !important;"><table class="premium-table resizable-table" style="margin:0; border:none;">'
